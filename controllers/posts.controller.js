...
module.exports.detail = (req, res) => {
    ...
    Post.findById(id)
        ...
        .catch((error) =>{
            return res.status(404).json({message: `Post doesnt exist - Error listing post: ${error}`});
        })
}
...
module.exports.update = (req, res) => {
    ...
    Post.findByIdAndUpdate(id, body,{
        ...
        .catch((error) =>{
            return res.status(404).json({message: `Post doesnt exist - Error updating post: ${error}`});
        })
}
